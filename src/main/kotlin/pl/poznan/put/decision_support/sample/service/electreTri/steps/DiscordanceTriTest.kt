...
import pl.poznan.put.decision_support.sample.service.electre_shared.steps.DiscordanceShared
...
class DiscordanceTriTest : DiscordanceShared() {
    ...
    override fun calculate(variants: List<Variant>, criteria: List<Criterion>, context: MutableMap<String, Any>): LinkedList<Array<Array<Double>>>
    {
