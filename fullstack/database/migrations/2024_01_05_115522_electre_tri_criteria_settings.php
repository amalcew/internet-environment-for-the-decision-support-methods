...
return new class extends Migration
{
    ...
    {
        Schema::create('electre_tri_criteria_settings', function (Blueprint $table) {
            $table->id();
            $table->foreignId('electre_tri_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('electre_tri_criteria_settings');
    }
};
